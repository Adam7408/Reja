...
document.getElementById("create-form").addEventListener("submit", function (e) {
    ...
    axios // modern post, modern request
        ...
        .then((response) => {
            // serverdan response muvaffaqiyatli kelsa
            document
    ...
    if (e.target.classList.contains("edit-me")) {
        let userInput = prompt(
            ...
            e.target.parentElement.parentElement.querySelector(".item-text")
                .innerHTML
        ); // spanni classini olamiz, buning uchun bobosidan ruhsat olib spanni classini olamiz  ya'ni amakisini classini olyapmiz, va bizga uni texti kerak bo'lgani uchun innerHTMLni yozamiz
        ...
        if (userInput) {
            ...
            axios
                ...
                .then((response) => {
                    // shu yergacha faqat DataBaseda o'zgardi, endi viewda ya'ni reja.ejsda o'zgartiramiz
                    console.log(response.data);
...
document.getElementById("clear-all").addEventListener("click", function () {
    ...
    axios
        .post("/delete-all", { delete_all: true }) // delete-all elementimizni qiymati true bo'lsin
        .then((response) => {
